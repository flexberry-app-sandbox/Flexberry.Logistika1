...
namespace IIS.Logistika
{
    ...
    public class ТЧИнфОГрузе : ICSSoft.STORMNET.DataObject
    {
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Logistika.ЗагрузКонтейн.
        /// </summary>
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ТЧИнфОГрузеE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТЧИнфОГрузеE", typeof(IIS.Logistika.ТЧИнфОГрузе));
                }
            }
        }
    }
    ...
    public class DetailArrayOfТЧИнфОГрузе : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Logistika.DetailArrayOfТЧИнфОГрузе members)

        // *** End programmer edit section *** (IIS.Logistika.DetailArrayOfТЧИнфОГрузе members)
        ...
        /// </summary>
        public DetailArrayOfТЧИнфОГрузе(IIS.Logistika.ЗагрузКонтейн fЗагрузКонтейн) : 
                base(typeof(ТЧИнфОГрузе), ((ICSSoft.STORMNET.DataObject)(fЗагрузКонтейн)))
        {
        }
        
        public IIS.Logistika.ТЧИнфОГрузе this[int index]
        {
            get
            {
                return ((IIS.Logistika.ТЧИнфОГрузе)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Logistika.ТЧИнфОГрузе dataobject)
        {
