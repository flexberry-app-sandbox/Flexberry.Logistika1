...
namespace IIS.Logistika
{
    ...
    public class Баржи : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Logistika.DetailArrayOfТЧРасписание fТЧРасписание;
        ...
        public virtual IIS.Logistika.DetailArrayOfТЧРасписание ТЧРасписание
        {
            get
            {
                ...
                {
                    this.fТЧРасписание = new IIS.Logistika.DetailArrayOfТЧРасписание(this);
                }
                IIS.Logistika.DetailArrayOfТЧРасписание result = this.fТЧРасписание;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View БаржиE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("БаржиE", typeof(IIS.Logistika.Баржи));
                }
            }
            ...
            public static ICSSoft.STORMNET.View БаржиL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("БаржиL", typeof(IIS.Logistika.Баржи));
                }
            }
        }
    }
