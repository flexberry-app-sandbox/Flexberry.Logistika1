...
namespace IIS.Logistika
{
    ...
    public class ЗагрузКонтейн : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Logistika.Контейнеры fКонтейнеры;
        
        private IIS.Logistika.Сотрудники fСотрудники;
        
        private IIS.Logistika.DetailArrayOfТЧИнфОГрузе fТЧИнфОГрузе;
        ...
        [PropertyStorage(new string[] {
                "Контейнеры"})]
        [NotNull()]
        public virtual IIS.Logistika.Контейнеры Контейнеры
        {
            get
            {
                ...
                IIS.Logistika.Контейнеры result = this.fКонтейнеры;
        ...
        [PropertyStorage(new string[] {
                "Сотрудники"})]
        [NotNull()]
        public virtual IIS.Logistika.Сотрудники Сотрудники
        {
            get
            {
                ...
                IIS.Logistika.Сотрудники result = this.fСотрудники;
        ...
        public virtual IIS.Logistika.DetailArrayOfТЧИнфОГрузе ТЧИнфОГрузе
        {
            get
            {
                ...
                {
                    this.fТЧИнфОГрузе = new IIS.Logistika.DetailArrayOfТЧИнфОГрузе(this);
                }
                IIS.Logistika.DetailArrayOfТЧИнфОГрузе result = this.fТЧИнфОГрузе;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ЗагрузКонтейнE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЗагрузКонтейнE", typeof(IIS.Logistika.ЗагрузКонтейн));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ЗагрузКонтейнL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЗагрузКонтейнL", typeof(IIS.Logistika.ЗагрузКонтейн));
                }
            }
        }
    }
