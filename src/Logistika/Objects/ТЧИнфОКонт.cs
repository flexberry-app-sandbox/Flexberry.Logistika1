...
namespace IIS.Logistika
{
    ...
    public class ТЧИнфОКонт : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Logistika.ЗагрузкаБаржи fЗагрузкаБаржи;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Logistika.ЗагрузкаБаржи.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "ЗагрузкаБаржи"})]
        public virtual IIS.Logistika.ЗагрузкаБаржи ЗагрузкаБаржи
        {
            get
            {
                ...
                IIS.Logistika.ЗагрузкаБаржи result = this.fЗагрузкаБаржи;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ТЧИнфОКонтE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТЧИнфОКонтE", typeof(IIS.Logistika.ТЧИнфОКонт));
                }
            }
        }
    }
    ...
    public class DetailArrayOfТЧИнфОКонт : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Logistika.DetailArrayOfТЧИнфОКонт members)

        // *** End programmer edit section *** (IIS.Logistika.DetailArrayOfТЧИнфОКонт members)
        ...
        /// </summary>
        public DetailArrayOfТЧИнфОКонт(IIS.Logistika.ЗагрузкаБаржи fЗагрузкаБаржи) : 
                base(typeof(ТЧИнфОКонт), ((ICSSoft.STORMNET.DataObject)(fЗагрузкаБаржи)))
        {
        }
        
        public IIS.Logistika.ТЧИнфОКонт this[int index]
        {
            get
            {
                return ((IIS.Logistika.ТЧИнфОКонт)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Logistika.ТЧИнфОКонт dataobject)
        {
